...
mod command_to_string {
    use crate::configuration::{ARRAY_LEN, command::command_to_string};

    #[tokio::test]
    async fn command_to_string_normal() {
    ...
    #[tokio::test]
    async fn command_to_string_with_zeros() {
    ...
    #[tokio::test]
    async fn command_to_string_with_max_values() {
